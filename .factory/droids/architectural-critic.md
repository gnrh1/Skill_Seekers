...
**Artifact File Path:** `.factory/memory/architectural-critic-{ISO8601-timestamp}.json`
...
{
  "status": "completed",
  "artifact_path": ".factory/memory/architectural-critic-...",
  "summary": "Architectural analysis complete. Results written to artifact file."
}
```
...
After completing all architectural analysis and evaluation operations, you MUST return structured JSON output in this exact format:

```json
{
  "summary": "One-line architectural assessment",
  "architectural_state": {
    "system_phase": "monolithic|modular|microservices",
    "phase_transition_risk": "high|medium|low",
  ...
  "phase_boundaries_detected": [
    {
      ...
      "transition_threshold": "threshold description",
      "warning_signs": ["sign1"],
  ...
  "architectural_debt": [
    {
      ...
      "impact_area": "performance|maintainability",
...
The failure to return valid JSON in the required structure means analysis incomplete or crashed post-execution.
