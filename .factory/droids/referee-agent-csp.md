...
tools: Read, Create, Execute, Glob, Grep
---
...
After completing all evaluation, synthesis, and selection operations, write results to:
**Artifact File Path:** `.factory/memory/referee-agent-csp-{ISO8601-timestamp}.json`
...
{
  "status": "completed",
  "artifact_path": ".factory/memory/referee-agent-csp-...",
  "summary": "Synthesis complete. Results written to artifact file."
}
```
