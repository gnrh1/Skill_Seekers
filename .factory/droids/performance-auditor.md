...
After completing all performance analysis and profiling operations, write results to a completion artifact file:

**Artifact File Path:**
```
.factory/memory/performance-auditor-{ISO8601-timestamp}.json
```
...
```json
{
  ...
  "timestamp": "2025-11-21T16:02:15Z",
  "summary": "Identified 3 critical bottlenecks. Memory optimization potential: 2.5GB. Estimated 40% performance improvement with 12 hours effort.",
  ...
  "bottleneck_analysis": [
    {
      "bottleneck": "Unoptimized database query in search_documents()",
      "location": "cli/doc_scraper.py:search_documents",
      "impact_percent": 35,
      "severity": "high",
      "optimization_approach": "Add index on category column and implement query batching"
    }
  ],
  "memory_analysis": {
    "peak_usage_mb": 2048,
    "memory_leaks_detected": ["Connection pool not releasing resources in error path"],
    "optimization_potential_mb": 2560
  },
  "optimization_recommendations": [
    {
      "optimization": "Implement connection pooling for database",
      "estimated_impact_percent": 35,
      "implementation_effort_hours": 4,
      "roi_metric": "2.5GB saved memory, 35% faster queries",
      "priority": "high"
    }
  ]
}
...
{
  "status": "completed",
  "artifact_path": ".factory/memory/performance-auditor-2025-11-21T16-02-15Z.json",
  "summary": "Performance analysis complete. Results written to artifact file."
}
```
...
- ✅ File path format: `.factory/memory/performance-auditor-{ISO8601-timestamp}.json`
