...
#### **PROTOCOL ENFORCEMENT: REQUIRED OUTPUT CONTRACT (Option C - File-Based Artifacts)**

After completing all security analysis operations, write results to:
**Artifact File Path:** `.factory/memory/security-analyst-{ISO8601-timestamp}.json`
...
{
  "status": "completed",
  "artifact_path": ".factory/memory/security-analyst-...",
  "summary": "Security analysis complete. Results written to artifact file."
}
```
...
The failure to return valid JSON in the required structure means security analysis incomplete or crashed post-execution.
